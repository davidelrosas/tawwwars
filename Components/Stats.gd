...
var detection_mode : DetectionArea.mode
...
func _init(max_health : float, detection_range : float, detection_mode : DetectionArea.mode, armor : float, ability_damage : float, movement_speed : float = 0):
